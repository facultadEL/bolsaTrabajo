<html>
	...
	?>
		<form class="cambioPassword" id="commentForm" action="guardarCambiarPasswordAlumno.php?idAlumno=<?php echo $id_alumno; ?>" method="post">
		<fieldset>
		...
		<br>
			...
			<a href="perfilAlumno.php?idAlumno=<?php echo $id_alumno; ?>"><input type="button" value="Atr&aacute;s"></a>
		<br>
		</form>
	</body>
</html>