...
<legend><FONT face="Cambria" size="4" color="#6E6E6E">Datos Login</FONT></legend>
	<table>
		...
		<tr>
			...
			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td>
				<a href="cambiarPasswordAlumno.php?idAlumno=<?php echo $id_alumno; ?>">Cambiar contrase&ntilde;a</a>
			</td>
		</tr>
	</table>
</fieldset>
		<br>
		<p>
			<a href="nuevoAlumno.php?regreso=1&idAlumno=<?php echo $id_alumno; ?>"><input type="button" value="Modificar"></a>
			<a href="opcionAlumno.php?idAlumno=<?php echo $id_alumno; ?>"><input type="button" value="Atr&aacute;s"></a>
		</p>
</form>
</body>
</html>